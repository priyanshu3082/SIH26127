...
The runnable prototype is in this folder. It includes a FastAPI backend, seeded multi-camera sightings, trajectory and traffic APIs, blacklist alerts, and a Leaflet dashboard.
